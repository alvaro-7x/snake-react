...
export class JuegoService
{
  ...
  getPuedeAtravesarParedes ()
  {
    return this.puedeAtravesarParedes;
  }
  getScore ()
  {
    return this.score;
  ...
  getVidasSss ()
  {
    return this.vidasSss;
  }
  getNivelJuego ()
  {
    return this.nivelJuego;
  }
  getNivelJuegoIncrementado ()
  {
    return this.nivelJuegoIncrementado;
  }
  getItemEspecialMostrado ()
  {
    return this.itemEspecialMostrado;
  }
  getJuegoPausado ()
  {
  ...
  getEstadoJuegoActual ()
  {
    return this.estadoJuegoActual;
  }
  getVelocidadJuego ()
  {
    return this.velocidadJuego;
  }
  getVelocidadSnake ()
  {
    return this.velocidadSnake;
  }
  ...
  // Setters
  setDireccionActual (direccionActual: number)
  {
    this.direccionActual = direccionActual;
  }
  setPuedeAtravesarParedes (puedeAtravesarParedes: boolean)
  {
    this.puedeAtravesarParedes = puedeAtravesarParedes;
  }
  ...
  setVidasSss (vidasSss: number)
  {
    this.vidasSss = vidasSss;
  }
  setNivelJuego (nivelJuego: number)
  {
    this.nivelJuego = nivelJuego;
  }
  setNivelJuegoIncrementado (nivelJuegoIncrementado: boolean)
  {
    this.nivelJuegoIncrementado = nivelJuegoIncrementado;
  }
  setItemEspecialMostrado (itemEspecialMostrado: boolean)
  {
    this.itemEspecialMostrado = itemEspecialMostrado;
  }
  setJuegoPausado (juegoPausado: boolean)
  {
    this.juegoPausado = juegoPausado;
  }
  setVersionOriginal (versionOriginal: boolean)
  {
    this.versionOriginal = versionOriginal;
  }
  setEstadoJuegoActual (estadoJuegoActual: number)
  {
    this.estadoJuegoActual = estadoJuegoActual;
  }
  setVelocidadJuego (velocidadJuego: number)
  {
    this.velocidadJuego = velocidadJuego;
  }
  setVelocidadSnake (velocidadSnake: number)
  {
    this.velocidadSnake = velocidadSnake;
  }
  ...
  setCtxDetallesJuego (ctx: CanvasRenderingContext2D)
  {
    this.ctxDetallesJuego = ctx;
  }
  setCtxControlesJuego (ctx: CanvasRenderingContext2D)
  {
    this.ctxControlesJuego = ctx;
  }
  ...
  dibujarBotonAccion (puntoX: number, puntoY: number, color:string, texto:string, radio:number, init = false)
  {
